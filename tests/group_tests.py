...
def test_choose_screening():
    ...
    # ]
    test_cases = [
        (FG1, [(S21, 10, 10, 27), (S31, 10, 10, 71), (S11, 10, 9, 46), (S12, 10, 7, 71), (S32, 7, 6, 27), (S13, 0, 0, 71), (S22, 0, 0, 71), (S33, 0, 0, 71)]),
        (FG2, [(S31, 10, 10, 71), (S11, 10, 8, 46), (S12, 9, 6, 71), (S13, 0, 0, 71), (S22, 0, 0, 71), (S33, 0, 0, 71)]),
        (FG3, [(S11, 10, 10, 46)])
    ]
...
def test_buy_tickets():
    ...
    test_cases = [
        ...
        (FG1, S31, 10), (FG1, S32, 7), (FG1, S33, 0),
        (FG2, S11, 10), (FG2, S12, 9), (FG2, S13, 0),
        (FG2, S21, 10), (FG2, S22, 0),
        (FG2, S31, 10), (FG2, S32, 5), (FG2, S33, 0),
        (FG3, S11, 10), (FG3, S12, 2), (FG3, S13, 0),
        (FG3, S21, 7), (FG3, S22, 0),
        (FG3, S31, 10), (FG3, S32, 0), (FG3, S33, 0)
    ]
